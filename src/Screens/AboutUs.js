          ...
          <div className="grid grid-flex-row xl:grid-cols-2 gap-4 xl:gap-16 items-center">
            <div>
              ...
              <div className="mt-3 text-sm leading-8 text-text">
                <p>
                  lorem ipsum yumkfg iutype dhtgfe shyeopfh thutebc, hrytavdnxh
                  lorem ipsum yumkfg iutype dhtgfe shyeopfh thutebc, hrytavdnxh
                  lorem ipsum yumkfg iutype dhtgfe shyeopfh thutebc, hrytavdnxh
                  lorem ipsum yumkfg iutype dhtgfe shyeopfh thutebc, hrytavdnxh
                  lorem ipsum yumkfg iutype dhtgfe shyeopfh thutebc, hrytavdnxh
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-8">
                <div className="p-8 bg-dry rounded-lg">
                  ...
                  <p className="mb-0 text-text leading-7 text-sm">
                    lorem ipsum is simply a dummy text hfhyyrnc
                  </p>
                </div>
                <div className="p-8 bg-dry rounded-lg">
            ...
            <div className="mt-10 lg:mt-0">
              <img src="/images/about2.jpeg" alt="aboutus" className="w-full xl:block hidden h-header rounded-lg object-cover" />
            </div>
          </div>
        </div>
      </div>
